...
export const MATERIALS_LIBRARY = {
  ...
  porteria_pequena: {
    ...
    fabricConfig: (x, y) => ({ left: x, top: y, width: 32, height: 21 }),
  },
  ...
  porteria_grande: {
    ...
    fabricConfig: (x, y) => ({ left: x, top: y, width: 44, height: 26 }),
  },
  ...
  escalera: {
    ...
    fabricConfig: (x, y) => ({ left: x, top: y, width: 22, height: 32 }),
  },
  ...
  pared_rebote: {
    ...
    fabricConfig: (x, y) => ({ left: x, top: y, width: 16, height: 26 }),
  },
