...
export const MATERIALS_LIBRARY = {
  ...
  porteria_pequena: {
    ...
    fabricConfig: (x, y) => ({ left: x, top: y, width: 64, height: 42 }),
  },
  ...
  porteria_grande: {
    ...
    fabricConfig: (x, y) => ({ left: x, top: y, width: 88, height: 52 }),
  },
  ...
  valla: {
    ...
    fabricConfig: (x, y) => ({ left: x, top: y, width: 56, height: 44 }),
  },
  ...
  escalera: {
    ...
    fabricConfig: (x, y) => ({ left: x, top: y, width: 44, height: 64 }),
  },
