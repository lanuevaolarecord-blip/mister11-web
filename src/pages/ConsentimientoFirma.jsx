...
const ConsentimientoFirma = () => {
  ...
  const handleGeneratePDF = async (e) => {
    ...
    try {
      ...
      const legalText3 = `En cumplimiento del RGPD (UE) 2016/679 y la LOPDGDD 3/2018 de España, se le informa que el responsable de los ficheros de tratamiento de la app es Jhojan Stiven Caicedo. Puede ejercer sus derechos de Acceso, Rectificación, Supresión u Oposición escribiendo directamente al correo oficial de soporte de la plataforma: lavozdelformador@gmail.com.`;
