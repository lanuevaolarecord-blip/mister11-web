...
import { MessageSquare, FileText, Pencil, Edit, X, UserPlus, Share2, Mail, Trash2, Bell, Megaphone, Flag, Ban, CheckCircle, AlertTriangle, TrendingUp, Users, Shield, ClipboardList } from 'lucide-react';
...
const MiEquipo = () => {
  ...
  return (
    <div className="page-wrapper">
      ...
      {/* FAB - Añadir Jugador (Oculto en otras pestañas y cuando la ficha o formulario está abierto) */}
      {!selectedPlayer && !isFormOpen && mainTeamTab === 'squad' && (
